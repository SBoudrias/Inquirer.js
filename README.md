...
- **pageSize**: (Number) Change the number of lines that will be rendered when using `list`, `rawList`, `expand` or `checkbox`. If not defined, current terminal height will be used to determine number of lines. 
