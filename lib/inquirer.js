...
inquirer.createPromptModule = function () {
   ...
   * Get a prompt type
   * @param {String} name     Prompt type name
   * @return {Function} Prompt constructor
   */

  promptModule.getPromptConstructor = function( name ) {
    return promptModule.prompts[ name ];
  };
  ...
  promptModule.restoreDefaultPrompts = function () {
    this.registerPrompt( "base", require("./prompts/base"));
