...
Prompt.prototype.getQuestion = function (renderDefault) {
  renderDefault = renderDefault || function(input) { return input };

  var message = chalk.green('?') + ' ' + chalk.bold(this.opt.message) + ' ';

  // Append the default if available, and if question isn't answered
  if ( this.opt.default != null && this.status !== 'answered' ) {
    message += chalk.dim('('+ renderDefault(this.opt.default) + ') ');
  }
