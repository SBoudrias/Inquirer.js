...
Prompt.prototype.run = function () {
  ...
  this.events.escapeKey.takeUntil(this.events.line).forEach(this.onEscapeKey.bind(this));
...
Prompt.prototype.onEscapeKey = function (state) {
  if (_.isFunction(this.opt.onEscapeKey)) {
    this.opt.onEscapeKey.call(this, state);
  } else {
    this.done(this.opt.onEscapeKey);
  }
};
