...
Prompt.prototype.onSubmit = function() {
  ...
  this.done( _.pluck(choices, "value") );
};
...
Prompt.prototype.getCheckbox = function( checked ) {
  var check = (process.platform === "win32") ? "X" : "✔";
  return checked ? clc.cyan("["+ check +"] ") : "[ ] ";
};
