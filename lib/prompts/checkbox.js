...
Prompt.prototype._run = function (cb) {
  ...
  this.events.normalizedUpKey.takeUntil(validation.success).forEach(this.onUpKey.bind(this));
  this.events.normalizedDownKey.takeUntil(validation.success).forEach(this.onDownKey.bind(this));
  this.events.numberKey.takeUntil(validation.success).forEach(this.onNumberKey.bind(this));
  this.events.spaceKey.takeUntil(validation.success).forEach(this.onSpaceKey.bind(this));
  this.events.aKey.takeUntil(validation.success).forEach(this.onAllKey.bind(this));
  this.events.iKey.takeUntil(validation.success).forEach(this.onInverseKey.bind(this));
