...
Prompt.prototype._run = function (cb) {
  ...
  this.events.normalizedUpKey.takeUntil(this.events.line).forEach(this.onUpKey.bind(this));
  this.events.normalizedDownKey.takeUntil(this.events.line).forEach(this.onDownKey.bind(this));
  this.events.numberKey.takeUntil(this.events.line).forEach(this.onNumberKey.bind(this));
  this.events.line
    .take(1)
