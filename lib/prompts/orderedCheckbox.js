...
Prompt.prototype._run = function (cb) {
  ...
  events.normalizedLeftKey.takeUntil(validation.success).forEach(this.orderUp.bind(this));
  events.normalizedRightKey.takeUntil(validation.success).forEach(this.orderDown.bind(this));
  // Init the prompt
  cliCursor.hide();
  this.render();
