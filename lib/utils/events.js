...
module.exports = function (rl) {
  ...
  return {
    ...
    allKey: keypress.filter(function (e) {
      return e.key && e.key.name === 'a';
    }).share(),
	
    noneKey: keypress.filter(function (e) {
      return e.key && e.key.name === 'n';
    }).share(),
	
    inverseKey: keypress.filter(function (e) {
      return e.key && e.key.name === 'i';
    }).share(),
	
    randomKey: keypress.filter(function (e) {
      return e.key && e.key.name === 'r';
    }).share()
  };
};
